...
// deze method pakket de company_name
function get_company_name(){
    $company_name =  \App\Models\Pages\HomePage::select('company_name')->first();
    if(!$company_name != Null)
        return 'company_name_is_empty';

    return $title = $company_name['company_name'];
}
...
// this method to get about page content
function get_default_about_page_content(){
    $get_default_about_page_content =  \App\Models\Pages\About::select('description')->first();
    if(!$get_default_about_page_content != Null)
        return 'default_about_page_content_is_empty';
    return $get_default_about_page_content = $get_default_about_page_content['description'];
}
