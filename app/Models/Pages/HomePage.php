...
class HomePage extends Model
{
    ...
    protected $fillable = [
        'id', 'title','company_name','description','logo','background','default_seo_image','ads_sidebar',
    ...
    public function scopeSelection($query)
    {
        ...
        return $query->select('id', 'title','company_name','description','logo','background','default_seo_image','ads_sidebar',
