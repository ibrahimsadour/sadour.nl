                                ...
                                <div class="widget-posts-list-container timeline-widget">
                                    <ul class="posts-list-items widget-posts-wrapper">
                                        ...
                                        <li class="widget-single-post-item">
                                            <a href="{{route('cities.index')}}" title="نقل عفش لجميع مدن الكويت">
                                                <h3>نقل عفش لجميع مدن الكويت</h3>
                                            </a>
                                        </li>
                                        <li class="widget-single-post-item">
                                            <a href="{{route('services.index')}}" title="خدمات نقل عفش الكويت">
                                                <h3>خدمات نقل عفش الكويت</h3>
                                            </a>
                                        </li>
                                        <li class="widget-single-post-item">
                                            <a href="{{route('tags.index')}}" title="نجار اثاث ايكيا">
                                                <h3>نجار اثاث ايكيا</h3>
                                            </a>
                                        </li>
