...
@section('title','تعديل معلومات الرئيسية')
@section('content')
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.home-page.update',$home_page ->id)}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label id="projectinput7" class="btn btn-float btn-float-lg btn-outline-pink">
                                                                <i class="la la-camera"><img style="background-color: black;" src="{{asset('assets/'.$home_page ->logo)}}" id="logo"  width="100" height="100"/></i>اضافة شعار الموقع (W250xH100px)
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="form-group">
                                                            <label id="projectinput7" class="btn btn-float btn-float-lg btn-outline-pink">
                                                                <i class="la la-camera"><img src="{{asset('assets/'.$home_page ->background)}}" id="background"  width="300" height="150"/></i>(W2000xH475px)اضافة خلفية الموقع
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="form-group">
                                                            <label id="projectinput7" class="btn btn-float btn-float-lg btn-outline-pink">
                                                                <i class="la la-camera"><img src="{{asset('assets/'.$home_page ->default_seo_image)}}" id="defaultseoimage"  width="300" height="150"/></i>(W780xH470px)اضافة default_seo_image الموقع
                                                                <input type="file" id="file" name="default_seo_image" style="display: none;" onchange="document.getElementById('defaultseoimage').src = window.URL.createObjectURL(this.files[0])">
                                                                <span class="file-custom"></span>
                                                            </label>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="form-group">
                                                            <label id="projectinput7" class="btn btn-float btn-float-lg btn-outline-pink">
                                                                <i class="la la-camera"><img src="{{asset('assets/'.$home_page ->ads_sidebar)}}" id="ads_sidebar"  width="300" height="150"/></i>(W336xH280px)اضافة ads_sidebar الموقع
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput1">Company name
                                                            </label>
                                                            <input type="text" id="name"
                                                                    class="form-control"
                                                                    placeholder="Company name"
                                                                    value="{{$home_page -> company_name}}"
                                                                    name="company_name">
                                                            @error("company_name")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
