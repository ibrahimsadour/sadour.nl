                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="scrollable-container media-list w-100">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h6 class="media-heading red darken-1">99٪ تحميل الخادم</h6>
                                            <p class="notification-text font-small-3 text-muted">Aliquam tincidunt
                                                mauris eu risus.</p>
                                            <small>
                                                <time class="media-meta text-muted"
                                                      datetime="2015-06-11T18:29:20+08:00">قبل خمس ساعات
                                                </time>
                                            </small>
                                        </div>
                                    </div>
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h6 class="media-heading yellow darken-3">إشعار تحذير</h6>
                                            <p class="notification-text font-small-3 text-muted">Vestibulum auctor
                                                dapibus neque.</p>
                                            <small>
                                                <time class="media-meta text-muted"
                                                      datetime="2015-06-11T18:29:20+08:00">اليوم
                                                </time>
                                            </small>
                                        </div>
                                    </div>
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h6 class="media-heading">اكمل المهمة</h6>
                                            <small>
                                                <time class="media-meta text-muted"
                                                      datetime="2015-06-11T18:29:20+08:00">الاسبوع الماضي
                                                </time>
                                            </small>
                                        </div>
                                    </div>
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h6 class="media-heading">توليد تقرير شهري</h6>
                                            <small>
                                                <time class="media-meta text-muted"
                                                      datetime="2015-06-11T18:29:20+08:00">الشهر الماضي
                                                </time>
                                            </small>
                                        </div>
                                    </div>
                            ...
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center"
                                                                href="javascript:void(0)">اقرأ جميع الإخطارات</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                ...
                                <span
                                    class="notification-tag badge badge-default badge-warning float-right m-0">4 جديد</span>
                            </li>
                            <li class="scrollable-container media-list w-100">
                                <a href="javascript:void(0)">
                                    <div class="media">
                          ...
                          <img src="{{asset('assets/admin/images/portrait/small/avatar-s-19.png')}}"
                               alt="avatar"><i></i></span>
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="notification-text font-small-3 text-muted">أنا أحب محفظتك ، لنبدأ.</p>
                                            <small>
                                                <time class="media-meta text-muted"
                                                      datetime="2015-06-11T18:29:20+08:00">اليوم
                                                </time>
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="{{asset('assets/admin/images/portrait/small/avatar-s-2.png')}}" alt="avatar"><i></i></span>
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="notification-text font-small-3 text-muted">لقد رأيت عملك
                                                there is</p>
                                            <small>
                                                <time class="media-meta text-muted"
                                                      datetime="2015-06-11T18:29:20+08:00">الثلاثاء
                                                </time>
                                            </small>
                                        </div>
                                    </div>
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="{{asset('assets/admin/images/portrait/small/avatar-s-6.png')}}" alt="avatar"><i></i></span>
                            ...
                            <li class="dropdown-menu-footer"><a class="dropdown-item text-muted text-center"
                                                                href="javascript:void(0)">اقرأ جميع الرسائل</a></li>
                        </ul>
                    </li>
